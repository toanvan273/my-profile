            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link href="/what-we-do">
                  <a className="nav-link active" aria-current="page" >What we do</a>
                  </Link>
              </li>
              <li className="nav-item">
                <Link href="/our-blog">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li onClick={()=> {changeLang('en')}}><a className="dropdown-item">English</a></li>
                  <li onClick={()=> {changeLang('vi')}}><a className="dropdown-item">Viet Nam</a></li>
                  <li onClick={()=> {changeLang('jp')}}><a className="dropdown-item">Japan</a></li>
